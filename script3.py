...
# Filtrage pour les mois de mai à août 2024
tracks_may_to_august = filter_tracks_may_to_august(all_tracks_2024)

# Sauvegarder les résultats dans un fichier JSON
with open('tracks_2024_may_to_august.json', 'w', encoding='utf-8') as f:
    json.dump(tracks_may_to_august, f, ensure_ascii=False, indent=4)

print(f"Total des morceaux récupérés de mai à août 2024 : {len(tracks_may_to_august)}")
